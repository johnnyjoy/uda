 ...
 */
final class Delete extends \UDA\Query
{
    use ConsumesCtes;
    ...
    /**
     * Build immutable `Sql` for this DELETE.
     *
     * @return Sql
     *
     * @throws QueryException If table is missing or WHERE is missing (unbounded delete guard)
     */
